...
function Checkout() {
    ...
    const validateZipCode = (zipCode) => {
        return /^[a-zA-Z0-9\- ]{3,10}$/.test(zipCode);
    };
    ...
    const validateForm = () => {
        ...
        if (customerInfo.zipCode && !validateZipCode(customerInfo.zipCode)) {
            errors.zipCode = 'Please enter a valid ZIP code';
        }
        
        // Payment info validation
        if (!paymentInfo.nameOnCard.trim()) errors.nameOnCard = 'Cardholder name is required';
    ...
    try {
        ...
        console.log('Creating booking with driver info:', {
            withDriver,
            driver,
        ...
        const bookingData = {
            ...
            ...(withDriver && driver && (driver._id || driver.id) && { 
                driverId: driver._id || driver.id 
            }),
            additionalServices: [],
                                ...
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div className="space-y-2">
                                            ...
                                            <input
                                                ...
                                                required
                                                className={`w-full px-4 py-3.5 bg-white/20 backdrop-blur-sm border ${fieldErrors.firstName ? 'border-red-500' : 'border-white/30'} rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 text-gray-900 placeholder-gray-500 transition-all duration-300 shadow-lg`}
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <input
                                                ...
                                                onChange={handleCustomerInfoChange}
                                                required
                                                className={`w-full px-4 py-3.5 bg-white/20 backdrop-blur-sm border ${fieldErrors.lastName ? 'border-red-500' : 'border-white/30'} rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 text-gray-900 placeholder-gray-500 transition-all duration-300 shadow-lg`}
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div className="space-y-2">
                                            ...
                                            <input
                                                ...
                                                onChange={handleCustomerInfoChange}
                                                required
                                                className={`w-full px-4 py-3.5 bg-white/20 backdrop-blur-sm border ${fieldErrors.email ? 'border-red-500' : 'border-white/30'} rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 text-gray-900 placeholder-gray-500 transition-all duration-300 shadow-lg`}
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <input
                                                ...
                                                className={`w-full px-4 py-3.5 bg-white/20 backdrop-blur-sm border ${fieldErrors.phone ? 'border-red-500' : 'border-white/30'} rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 text-gray-900 placeholder-gray-500 transition-all duration-300 shadow-lg`}
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <input
                                            ...
                                            onChange={handleCustomerInfoChange}
                                            required
                                            className={`w-full px-4 py-3.5 bg-white/20 backdrop-blur-sm border ${fieldErrors.address ? 'border-red-500' : 'border-white/30'} rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 text-gray-900 placeholder-gray-500 transition-all duration-300 shadow-lg`}
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div className="space-y-2">
                                            ...
                                            <input
                                                ...
                                                onChange={handleCustomerInfoChange}
                                                required
                                                className={`w-full px-4 py-3.5 bg-white/20 backdrop-blur-sm border ${fieldErrors.city ? 'border-red-500' : 'border-white/30'} rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 text-gray-900 placeholder-gray-500 transition-all duration-300 shadow-lg`}
                                                placeholder="Colombo"
                                            />
                                            {fieldErrors.city && (
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <input
                                                ...
                                                className={`w-full px-4 py-3.5 bg-white/20 backdrop-blur-sm border ${fieldErrors.zipCode ? 'border-red-500' : 'border-white/30'} rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 text-gray-900 placeholder-gray-500 transition-all duration-300 shadow-lg`}
                                                placeholder="00100"
                                            />
                                            {fieldErrors.zipCode && (
                                        ...
                                        <div className="space-y-6">
                                            <div className="space-y-2">
                                                ...
                                                <input
                                                    ...
                                                    required
                                                    className={`w-full px-4 py-3.5 bg-white/20 backdrop-blur-sm border ${fieldErrors.nameOnCard ? 'border-red-500' : 'border-white/30'} rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 text-gray-900 placeholder-gray-500 transition-all duration-300 shadow-lg`}
                                                    placeholder="John Doe"
                                                />
                                                {fieldErrors.nameOnCard && (
                                                    <p className="text-red-500 text-sm mt-1">{fieldErrors.nameOnCard}</p>
                                                )}
                                            </div>
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <input
                                                    ...
                                                    className={`w-full px-4 py-3.5 bg-white/20 backdrop-blur-sm border ${fieldErrors.cardNumber ? 'border-red-500' : 'border-white/30'} rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 text-gray-900 placeholder-gray-500 transition-all duration-300 shadow-lg`}
                                            ...
                                            <div className="grid grid-cols-2 gap-6">
                                                <div className="space-y-2">
                                                    ...
                                                    <input
                                                        ...
                                                        className={`w-full px-4 py-3.5 bg-white/20 backdrop-blur-sm border ${fieldErrors.expiryDate ? 'border-red-500' : 'border-white/30'} rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 text-gray-900 placeholder-gray-500 transition-all duration-300 shadow-lg`}
                                                        placeholder="MM/YY"
                                                        maxLength="5"
                                                    />
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    <input
                                                        ...
                                                        className={`w-full px-4 py-3.5 bg-white/20 backdrop-blur-sm border ${fieldErrors.cvv ? 'border-red-500' : 'border-white/30'} rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 text-gray-900 placeholder-gray-500 transition-all duration-300 shadow-lg`}
                                                        placeholder="123"
                                                        maxLength="4"
                                                    />
                                                    {fieldErrors.cvv && (
