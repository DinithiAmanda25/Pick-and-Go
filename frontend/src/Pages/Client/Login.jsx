        ...
        <div className="relative z-10 flex flex-col justify-center items-center w-full p-12 text-white">
          ...
          <div className="text-center max-w-md space-y-6">
            ...
            <p className="text-lg text-blue-100/80 leading-relaxed font-light">
              Sign in to access your account and continue your journey with Pick & Go - your trusted vehicle rental platform.
            </p>
          </div>
        ...
        <div className="max-w-md w-full space-y-8 relative z-20">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full flex justify-center py-3 px-4 border border-transparent text-white font-medium rounded-lg bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200 disabled:opacity-70 disabled:cursor-not-allowed"
            >
              {isLoading ? (
