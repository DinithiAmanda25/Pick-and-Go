...
function DriverSidebar() {
  ...
  const menuItems = [
    ...
    {
      name: 'Active Trips',
      path: '/driver-dashboard?tab=trips',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Trip History',
      path: '/driver-dashboard?tab=history',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Earnings',
      path: '/driver-dashboard?tab=earnings',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div className="bg-orange-900 text-white w-64 min-h-screen p-4">
      ...
      <nav className="space-y-2">
        {menuItems.map((item) => {
          ...
          let isActive = false
          if (item.path === '/driver-dashboard?tab=overview') {
            isActive = currentTab === 'overview'
          } else if (item.path === '/driver-dashboard?tab=trips') {
            isActive = currentTab === 'trips'
          } else if (item.path === '/driver-dashboard?tab=history') {
